...
import br.edu.priscila.escola.Modelos.AlunoModelo;
...
public class AlunoConsulta extends javax.swing.JFrame {
    ...
    AlunoWS alunoWebService;
    AlunoModelo modelo;
    List<AlunoVO> vAluno;

    public AlunoConsulta() {
        alunoWebService = new AlunoWS();
        vAluno = new ArrayList<>();
        modelo = new AlunoModelo(vAluno);
        initComponents();
    }
    
    private void cadastrar(){
        AlunoCadastro form = new AlunoCadastro();
        form.setVisible(true);
        form.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    }
    
    private void consultar() throws PriException{
        vAluno = alunoWebService.consultarTodos();
        tblConsulta.setModel(new AlunoModelo(vAluno));
        modelo = (AlunoModelo) tblConsulta.getModel();
        colunas();
    }
