...
import br.edu.priscila.escola.Modelos.ProfessorModelo;
...
public class ProfessorConsulta extends javax.swing.JFrame {
    ...
    ProfessorWS professorWebService;
    ProfessorModelo modelo;
    List<ProfessorVO> vProfessor;
    
    public ProfessorConsulta() {
        professorWebService = new ProfessorWS();
        vProfessor = new ArrayList<>();
        modelo = new ProfessorModelo(vProfessor);
        initComponents();
    }
    
    private void cadastrar(){
        ProfessorCadastro form = new ProfessorCadastro(new ProfessorVO());
        form.setVisible(true);
        form.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    }
    
    private void consultar() throws PriException{
        vProfessor = professorWebService.consultarTodos();
        tblConsulta.setModel(new ProfessorModelo(vProfessor));
        modelo = (ProfessorModelo) tblConsulta.getModel();
        colunas();
    }
